...
// API call failed to load images, causing 429. Removing dynamic fetch.
...
export default function HeroSlider() {
    ...
    const [slides] = useState(sliderConfig);

    // Dynamic image loading removed to prevent API Rate Limits (429)
    // The static images above are high quality and sufficient. 
